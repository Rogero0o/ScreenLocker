...
public class MatchPath {
    ...
    static {
        ...
        float[][] LETTERS = new float[][] { new float[] {
                // A
                24, 0, 1, 22, 1, 22, 1, 72, 24, 0, 47, 22, 47, 22, 47, 72, 1,
                48, 47, 48 },

                new float[] {
                        // B
                        0, 0, 0, 72, 0, 0, 37, 0, 37, 0, 47, 11, 47, 11, 47, 26,
                        47, 26, 38, 36, 38, 36, 0, 36, 38, 36, 47, 46, 47, 46,
                        47, 61, 47, 61, 38, 71, 37, 72, 0, 72, },
                ...
                new float[] {
                        // D
                        0, 0, 0, 72, 0, 0, 24, 0, 24, 0, 47, 22, 47, 22, 47, 48,
                        47, 48, 23, 72, 23, 72, 0, 72, },

                new float[] {
                        // E
                        0, 0, 0, 72, 0, 0, 47, 0, 0, 36, 37, 36, 0, 72, 47,
                        72, },
                ...
                new float[] {
                        // O
                        0, 0, 0, 72, 0, 72, 47, 72, 47, 72, 47, 0, 47, 0, 0,
                        0, },

                new float[] {
                        // P
                        0, 0, 0, 72, 0, 0, 47, 0, 47, 0, 47, 36, 47, 36, 0,
                        36, },
                ...
                new float[] {
                        // S
                        47, 0, 0, 0, 0, 0, 0, 36, 0, 36, 47, 36, 47, 36, 47, 72,
                        47, 72, 0, 72, },
        ...
        final float[][] NUMBERS = new float[][] { new float[] {
                // 0
                ...
                new float[] {
                        // 2
                        0, 0, 47, 0, 47, 0, 47, 36, 47, 36, 0, 36, 0, 36, 0, 72,
                        0, 72, 47, 72 },
                ...
                new float[] {
                        // 9
                        47, 0, 0, 0, 0, 0, 0, 36, 0, 36, 47, 36, 47, 0, 47,
                        72, } };
        // A - Z
        ...
        //上下横线
        addChar(H_TOP_BOTTOM,
                new float[] { 0, -45, 23, -45, 23, -45, 67, -45, 0, 120, 23,
                        120, 23, 120, 67, 120 });
