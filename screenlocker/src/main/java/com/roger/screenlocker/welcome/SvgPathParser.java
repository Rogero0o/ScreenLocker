...
class SvgPathParser {
                ...
                case 'c': {
                    ...
                    if (mCurrentPoint.x == Float.NaN) {
                        throw new ParseException(
                                "Relative commands require current point",
                                mIndex);
                    }
                    ...
                    while (advanceToNextToken() == TOKEN_VALUE) {
                        ...
                        p.cubicTo(tempPoint1.x, tempPoint1.y, tempPoint2.x,
                                tempPoint2.y, tempPoint3.x, tempPoint3.y);
                    }
    ...
    private char consumeCommand() throws ParseException {
        advanceToNextToken();
        if (mCurrentToken != TOKEN_RELATIVE_COMMAND &&
    ...
    private void consumeAndTransformPoint(PointF out, boolean relative)
    ...
    private float consumeValue() throws ParseException {
        ...
        try {
            ...
            throw new ParseException("Invalid float value '" + str + "'.",
                    mIndex);
        }
    }
}
