...
public class DrawInsetsFrameLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInsetBackground = a.getDrawable(
                R.styleable.DrawInsetsFrameLayout_insetBackground);
        mTopInsetBackground = a.getDrawable(
                R.styleable.DrawInsetsFrameLayout_topInsetBackground);
        mBottomInsetBackground = a.getDrawable(
                R.styleable.DrawInsetsFrameLayout_bottomInsetBackground);
        mSideInsetBackground = a.getDrawable(
                R.styleable.DrawInsetsFrameLayout_sideInsetBackground);
    ...
    @Override protected void onDraw(Canvas canvas) {
        ...
        if (mInsets != null) {
            ...
            // Left
            mTempRect.set(0, mInsets.top, mInsets.left,
            ...
            // Right
            mTempRect.set(width - mInsets.right, mInsets.top, width,
                    height - mInsets.bottom);
            if (mInsetBackground != null) {
                mInsetBackground.setBounds(mTempRect);
                mInsetBackground.draw(canvas);
