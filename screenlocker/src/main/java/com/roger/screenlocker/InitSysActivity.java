...
public class InitSysActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTextFont();
        localSharedPreferences.edit().putBoolean(PREFS_IS_INIT, true).commit();//设置初始化完成
    ...
    public void onResume() {
        ...
        getFragmentManager().beginTransaction()
                .add(R.id.frame_init,
                        RendererFragment.createInstance(UriUtil.getImageAbsolutePath(InitSysActivity.this, BaseActivity.mUri)))
                .commit();
    }
