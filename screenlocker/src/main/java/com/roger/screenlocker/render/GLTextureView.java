...
public class GLTextureView extends TextureView
     ...
     * indicates
     * that an error has occurred. This can be used to help track down which
     * OpenGL ES call
     * is causing an error.
     *
     * @see #getDebugFlags
     ...
     * {@link GLWrapper#wrap(javax.microedition.khronos.opengles.GL)} method is
     * called
     ...
     * the
     * Android device that the program is running on can support an arbitrary
     * number of EGL
     * contexts or not. Devices that can only support a limited number of EGL
     * contexts must
     * release the  EGL context in order to allow multiple applications to share
     * the GPU.
     * <p>
     ...
     * a GLSurfaceView.
     * <p>The following GLSurfaceView methods can only be called
     * <em>before</em>
    ...
    public void setEGLConfigChooser(int redSize, int greenSize, int blueSize, int alphaSize, int depthSize, int stencilSize) {
        setEGLConfigChooser(
                new ComponentSizeChooser(redSize, greenSize, blueSize,
     ...
     * <p>If this method is called, it must be called before {@link
     * #setRenderer(Renderer)}
     * is called.
     * <p>This method only affects the behavior of the default EGLContexFactory
     * and the
     * default EGLConfigChooser. If
     * {@link #setEGLContextFactory(EGLContextFactory)} has been called, then
     * the supplied
     * EGLContextFactory is responsible for creating an OpenGL ES 2.0-compatible
     * context.
     * If
     * {@link #setEGLConfigChooser(EGLConfigChooser)} has been called, then the
     * supplied
     * EGLConfigChooser is responsible for choosing an OpenGL ES 2.0-compatible
     * config.
     *
     ...
     * is created, or when {@link #requestRender} is called. Defaults to
     * RENDERMODE_CONTINUOUSLY.
     * <p>
     * Using RENDERMODE_WHEN_DIRTY can improve battery life and overall system
     * performance
     * by allowing the GPU and CPU to idle when the view does not need to be
     * updated.
     * <p>
    ...
    /**
     * Inform the view that the activity is resumed. The owner of this view
     * must
     ...
     * that implemented all the GL methods by delegating to another GL
     * instance.
     ...
     * {@link android.opengl.GLSurfaceView#setEGLContextFactory(EGLContextFactory)}
     */
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public void destroyContext(EGL10 egl, EGLDisplay display, EGLContext context) {
            if (!egl.eglDestroyContext(display, context)) {
                Log.e("DefaultContextFactory",
                        "display:" + display + " context: " + context);
                if (LOG_THREADS) {
                    Log.i("DefaultContextFactory",
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link android.opengl.GLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
    ...
    public interface EGLConfigChooser {
         ...
         * {@link javax.microedition.khronos.egl.EGL10#eglChooseConfig} and
         * iterating through the results. Please consult the
         * EGL specification available from The Khronos Group to learn how to
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        public ComponentSizeChooser(int redSize, int greenSize, int blueSize, int alphaSize, int depthSize, int stencilSize) {
            super(new int[] { EGL10.EGL_RED_SIZE, redSize, EGL10.EGL_GREEN_SIZE,
                    greenSize, EGL10.EGL_BLUE_SIZE, blueSize,
                    EGL10.EGL_ALPHA_SIZE, alphaSize, EGL10.EGL_DEPTH_SIZE,
                    depthSize, EGL10.EGL_STENCIL_SIZE, stencilSize,
                    EGL10.EGL_NONE });
            mValue = new int[1];
            mRedSize = redSize;
    ...
    private static class EglHelper {
        ...
        public void start() {
            if (LOG_EGL) {
                Log.w("EglHelper",
                        "start() tid=" + Thread.currentThread().getId());
            }
            /*
             * Get an EGL instance
             */
            ...
            if (view == null) {
                ...
                mEglConfig = view.mEGLConfigChooser.chooseConfig(mEgl,
                        mEglDisplay);
                ...
                */
                mEglContext = view.mEGLContextFactory.createContext(mEgl,
        ...
        GL createGL() {
            ...
            if (view != null) {
                ...
                if ((view.mDebugFlags &
                        (DEBUG_CHECK_GL_ERROR | DEBUG_LOG_GL_CALLS)) != 0) {
                    int configFlags = 0;
                    Writer log = null;
        ...
        private void destroySurfaceImp() {
            if (mEglSurface != null && mEglSurface != EGL10.EGL_NO_SURFACE) {
                ...
                GLTextureView view = mGLTextureViewWeakRef.get();
                if (view != null) {
                    view.mEGLWindowSurfaceFactory.destroySurface(mEgl,
        ...
        public void finish() {
            if (LOG_EGL) {
                Log.w("EglHelper",
                        "finish() tid=" + Thread.currentThread().getId());
            }
            if (mEglContext != null) {
                GLTextureView view = mGLTextureViewWeakRef.get();
                if (view != null) {
                    view.mEGLContextFactory.destroyContext(mEgl, mEglDisplay,
                            mEglContext);
                }
                mEglContext = null;
            }
        ...
        public static String formatEglError(String function, int error) {
            return function +
                    " failed"; // + EGLLogWrapper.getErrorString(error);
        }
    ...
    static class GLThread extends Thread {
                ...
                while (true) {
                    ...
                    switch (swapError) {
                        ...
                        default:
                            ...
                            EglHelper.logEglErrorAsWarning("GLThread",
        ...
        private boolean readyToDraw() {
            return (!mPaused) && mHasSurface && (!mSurfaceIsBad) &&
                    (mWidth > 0) && (mHeight > 0) && (mRequestRender ||
                    (mRenderMode == RENDERMODE_CONTINUOUSLY));
        }
        ...
        public void surfaceCreated() {
            synchronized (sGLThreadManager) {
                ...
                sGLThreadManager.notifyAll();
                while (mWaitingForSurface && !mFinishedCreatingEglSurface &&
                        !mExited) {
                    try {
                        sGLThreadManager.wait();
                    } catch (InterruptedException e) {
         ...
         * is garbage
         * called. This weak reference allows the GLSurfaceView to be garbage
         * collected while
    ...
    private static class GLThreadManager {
        ...
        public synchronized void checkGLDriver(GL10 gl) {
            if (!mGLESDriverCheckComplete) {
                ...
                if (mGLESVersion < kGLES_20) {
                    mMultipleGLESContextsAllowed = !renderer.startsWith(
                            kMSM7K_RENDERER_PREFIX);
                    notifyAll();
                }
         ...
         * 3.0 provides
         * support for hardware-accelerated views, therefore multiple EGL
         * contexts are
