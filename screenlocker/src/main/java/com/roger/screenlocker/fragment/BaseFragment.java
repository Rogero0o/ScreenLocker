...
public abstract class BaseFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentFace = Typeface.createFromAsset(mContext.getAssets(), "font/cartoon.ttf");
        BaseActivity.localSharedPreferences.registerOnSharedPreferenceChangeListener(this);

        mRendererFragment = RendererFragment.createInstance(UriUtil.getImageAbsolutePath(getActivity(), BaseActivity.mUri));
