...
public class GestureSettingFragment extends BaseFragment
    ...
    public void init() {
        ...
        gestureLockView = (GestureLockView) mView.findViewById(
                    ...
                    public void OnGestureFinish(boolean success, String key) {
                        ...
                        if (setGestureTimes == 1) {
                            ...
                            if (firstkey.equals(key)) {
                                mTextView.setText(
                                        R.string.gesture_setting_note3);
                            }
                            else {
                                mTextView.setTextColor(
                                        getResources().getColor(R.color.red));
                                mTextView.setText(
                                        R.string.gesture_setting_save_error);
                                ...
                                btn_gestureset.setText(getResources().getString(
                                        R.string.gesture_setting_set_continue));
                                mHandler.sendEmptyMessageDelayed(MSG_RESULT,
                                        2000);
                            }
                        }
                    }
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_gestureset:
                if (setGestureTimes == 1) {
                    ...
                    btn_gestureset.setText(getResources().getString(
                            R.string.gesture_setting_set_sure));
                }
                else if (setGestureTimes == 2) {
                    if (firstkey.equals(key)) {
                        ...
                        Toast.makeText(mContext, getResources().getString(
                                R.string.gesture_setting_save_success),
                                Toast.LENGTH_SHORT).show();
