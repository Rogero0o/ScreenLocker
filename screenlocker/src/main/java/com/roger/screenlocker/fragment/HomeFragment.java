...
public class HomeFragment extends BaseFragment {
    ...
    void initUI() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getActivity(),R.layout.spinner_item, arr);
        ...
        if(!BaseActivity.localSharedPreferences.getBoolean(mHomeActivity.PREFS_IS_OPEN, false)){
            mSpinner.setSelection(0);
        } else if (BaseActivity.localSharedPreferences.getBoolean(BaseActivity.PREFS_IS_SLIDE_MODE, true)) {
